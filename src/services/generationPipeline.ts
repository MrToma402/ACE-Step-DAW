...
const WAVE_SUBTRACTION_MIN_GAIN = 0.65;
const WAVE_SUBTRACTION_MAX_GAIN = 1.6;
const WAVE_SUBTRACTION_ADAPTIVE_ALPHA = true;
const WAVE_SUBTRACTION_ADAPTIVE_FLOOR = 0.7;
const WAVE_SUBTRACTION_CORRELATION_STRIDE = 4;
const WAVE_SUBTRACTION_LAG_COMPENSATION = true;
const WAVE_SUBTRACTION_MAX_LAG_SAMPLES = 64;
...
const WAVE_SUBTRACTION_DECORRELATE_RESIDUAL = false;
